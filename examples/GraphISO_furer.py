...
gi = qw.GraphISO(verbose=True,freqTol=0.01,bosonic=True)
...
cert1, cert2, checkISO = gi.isomorphicQ(adj1, adj2,
                            saveCert1='out/g3f1cert-new-BH.txt',
                            saveCert2='out/g3f2cert-new-BH.txt')
...
cert1, cert1p, checkISO = gi.isomorphicQ(cert1, adj1p,
                            saveCert2='out/g3f1p1cert-new-BH.txt')
if rank == 0:
    print(checkISO)
